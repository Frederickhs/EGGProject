...
const unsigned long redDoublePressWindow = 200;
const unsigned long resetFlashToggleTime = 200;
const int resetFlashToggleCount = 6;
...
const unsigned long gameIntroToggleTime = 167;
const int gameIntroToggleCount = 12;


const unsigned long gameEndFlashToggleTime = 167;
const int gameEndFlashToggleCount = 6;
const unsigned long gameRestartWaitTime = 3000;
...
const unsigned long simonInputFeedbackTime = 1500;
...
const unsigned long whackStartOnTime = 2000;
const unsigned long whackSpeedStep = 150;
const unsigned long whackMinOnTime = 300;
